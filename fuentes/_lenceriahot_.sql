...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2014 a las 05:21:46
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='carrito de compras' AUTO_INCREMENT=35 ;
...
(34, 1, 3, 0, 0, 1, '2014-02-21 22:48:40', 0),
(33, 1, 2, 2, 1, 2, '2014-02-21 22:35:55', 0),
(32, 1, 4, 0, 0, 4, '2014-02-21 22:29:59', 0);
...
(1, 'Mujer', 'mujer', 'esto es para mujeres y es editable con..', '12-33.jpg', 1, 33),
(2, 'Mujersota', 'mujersota', 'asdasd sad ', '12-33.jpg', 1, 14),
...
(1, 'producto 1', 'producto-1', '50', '40', 1, 'cb.,h jvb cxg ,v bcxb vcjxh vj,xc', '<p>lkchvbdf jkhcxhvbj, hjxhcxj,hkjfcbhj,cvh cb vjghj,chxjgh ,fd.hgjkdhfg,fgj kflhjfilgjkh gfj jgkljh fkkkkkkkkkkkkkkkkl lfkhjgkfj gkhbl</p>', '1.jpg', '44', '<iframe width="70%" height="100%" src="//www.youtube.com/embed/xdlKfXeZx9s" frameborder="0" allowfullscreen></iframe>', 1, 1, 1, NULL, '2013-12-06 13:31:17', 5),
(2, 'Producto 2', 'Producto-2', '25.00', NULL, 0, 'jkzxv mb fj,hxj kgh dfjkghjkcvbh f\r\ndf gkjfklgjklhd', 'lkjg lkdjgldfjg kf\r\ngf gklfdj gkgjh\r\nhgjkgklhg jghklj', '2.jpg', '95% Polyester / 95% Polyester\n5% Spandex / 5%', '<iframe width="70%" height="100%" src="//www.youtube.com/embed/xdlKfXeZx9s" frameborder="0" allowfullscreen></iframe>', 1, 1, 1, NULL, '2013-12-13 11:25:00', 4),
(3, 'Producto-3', 'producto-3', '522.00', '36.00', 1, 'dsdasdsa', ' sadsadasd', '3.jpg', '95% Polyester / 95% Polyester\n5% Spandex / 5%', '<iframe width="70%" height="100%" src="//www.youtube.com/embed/xdlKfXeZx9s" frameborder="0" allowfullscreen></iframe>', 1, 1, 1, '2014-02-26 00:00:00', '2014-02-21 00:00:00', 9),
(4, 'Subida Por Primera Vez', 'subida-por-primera-vez', '25', '30', 1, 'Este es un producto de mela', '<p>Pruebon pe loco</p><p><strong>Tu Sabe que tiene que ser asi</strong></p><ol><li>Paque mas</li><li>lelele</li></ol>', '12.jpg', '95% Polyester / 95% Polyester\n5% Spandex / 5%', '<iframe width="70%" height="100%" src="//www.youtube.com/embed/xdlKfXeZx9s" frameborder="0" allowfullscreen></iframe>', 1, 1, 1, NULL, NULL, 7),
(5, 'Subida Por Primera Vez2', 'subida-por-primera-vez2', '25', '30', 0, 'Este es un producto de mela', '<p>Pruebon pe loco</p><p><strong>Tu Sabe que tiene que ser asi</strong></p><ol><li>Paque mas</li><li>lelele</li></ol>', '12.jpg', '95% Polyester / 95% Polyester\n5% Spandex / 5%', '<iframe width="70%" height="100%" src="//www.youtube.com/embed/xdlKfXeZx9s" frameborder="0" allowfullscreen></iframe>', 0, 0, 1, NULL, '2014-02-13 16:18:25', 0);
...
(1, 'Chompas', 'chopinias', 'chopas de lanita pes señora', '12-33.jpg', 1, NULL, 1, 26),
...
(1, 'Ronny', 'Cabrera Sinarahua', '45991958', 'ronny_2the_fly7@hotmail.com', '939d3aa4a2d840551137a8d9933e9af6', NULL, 9684756, 966354311, NULL, NULL, 0, NULL, NULL, '2014-02-26 22:35:06', 1, 1, '0', ''),
(2, 'asdsa', 'Cabrera', NULL, 'ronny_the_fly7@hotmail.com', '939d3aa4a2d840551137a8d9933e9af6', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '2014-02-23 12:14:52', 0, 1, '127.0.0.1', '43ddc58b03022163180a80602f6985');
