...
?>
<script>
opener.document.form1.img_producto.value="<?php echo $nombre_archivo; ?>";
self.close();
</script>
<?php
}
...
<form action="subir-imagen-producto.php" method="post" enctype="multipart/form-data" id="form1">
<p>
