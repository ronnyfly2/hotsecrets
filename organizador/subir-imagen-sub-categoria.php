...
move_uploaded_file($_FILES['userfile']['tmp_name'], "../imagenes/subcategorias/".$nombre_archivo);	
?>
<script>
opener.document.form1.img_subcat.value="<?php echo $nombre_archivo; ?>";
self.close();
</script>
<?php
}
...
<form action="subir-imagen-sub-categoria.php" method="post" enctype="multipart/form-data" id="form1">
<p>
